...
export function Navbar() {
    ...
    return (
        <header className="bg-transparent inset-x-0 z-50">
            ...
            <nav aria-label="Global" className="flex items-center justify-around sm:px-40  lg:px-40 sm:py-3 lg:py-3  ">
                <div className="flex lg:flex-1">
                    <Link  to="/" className="">
                        <span className="text-3xl text-white font-bold">Movie<span className="text-red-600">Out</span></span>
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    {navigation.map((item) => (
                        <Link  key={item.name} to={item.to} className="text-base font-sem leading-6 text-white hover:text-red-600 transition ease-in-out">
                            {item.name}
                        </Link >
                    ))}
                </div>
...
export function Footer() {
    return (
        <footer className="w-full bg-neutral-900 text-center text-white dark:bg-neutral-900 mt-32">
